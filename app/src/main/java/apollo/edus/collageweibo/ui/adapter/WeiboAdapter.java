...
public class WeiboAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public WeiboAdapter(List<WeiboResult.WeiboInfo> datas, Context context) {
 ...
 /*                   Intent intent = new Intent(mContext, OriginPicTextCommentActivity.class);
            ...
            FillContent.fillWeiBoImgList(mDatas.get(position), mContext, ((RetweetViewHolder) holder).retweet_imageList);
...
/*                    Intent intent = new Intent(mContext, RetweetPicTextCommentActivity.class);
    ...
    public void setData(List<WeiboResult.WeiboInfo> data) {
        mDatas.clear();
